...
export const diseaseCategories: Record<
  DiseaseCategory,
...
export const diseases: Disease[] = [
  ...
  },
  {
    ...
    medicines: [{ name: 'Penicillin G', purpose: 'Emergency antibiotic', rating: 3.0 }],
    notes: [
  ...
  },
  {
    ...
    medicines: [{ name: 'Surgical intervention', purpose: 'Definitive treatment', rating: 4.8 }],
    notes: [
  ...
  },
  {
    ...
    prevention: ['Same as endometritis', 'Treat uterine infections early', 'Good calving hygiene'],
    treatment: [
  ...
  },
  {
    ...
    prevention: ['Fly control', 'Moraxella bovis vaccine', 'Provide shade', 'Reduce dust'],
    treatment: [
...
export const recommendedProducts: RecommendedProduct[] = [
  ...
  {
    name: 'Sumo Ultra Calcium',
    category: 'Calcium',
    rating: 4.7,
    purpose: 'Oral calcium supplement',
  },
  // Minerals
  ...
  // Bypass Fat
  {
    ...
    category: 'Bypass Fat',
    rating: 4.8,
    purpose: 'Energy supplement for high yielders',
  },
  ...
  {
    name: 'Taktic (Flumethrin)',
    category: 'Tick Control',
    rating: 4.7,
    purpose: 'Pour-on tick control',
  },
  // Respiratory
  {
    name: 'Draxxin',
    category: 'Respiratory',
    rating: 4.8,
    purpose: 'Single dose pneumonia treatment',
  },
...
export const preventionTips: PreventionTip[] = [
  {
    ...
    description:
      'FMD every 6 months, HS+BQ annual (before monsoon), LSD annual. Use FREE government vaccines (NADCP).',
    icon: '💉',
  ...
  },
  {
    ...
    description:
      'Most diseases are due to mineral deficiency. Use Virtamin Gold or Refit (30-50g per day).',
    icon: '🧂',
    category: 'nutrition',
  },
  {
...
export const trustedCompanies = ['Intas', 'Zydus', 'Virbac', 'Zoetis', 'Hester', 'Vetoquinol'];
