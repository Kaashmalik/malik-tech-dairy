  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl md:text-2xl font-bold dark:text-white">Create New Farm</h1>
          <p className="text-sm text-gray-500">Add a new farm to the platform</p>
        </div>
      </div>

      {/* Form */}
      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 space-y-6">
        {/* Farm Details */}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={formData.province} onValueChange={(v) => setFormData(s => ({ ...s, province: v }))}>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select value={formData.plan} onValueChange={(v) => setFormData(s => ({ ...s, plan: v }))}>
              <SelectTrigger className="mt-1.5">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t">
          ...
          <Button type="submit" disabled={loading} className="flex-1 sm:flex-none bg-emerald-600 hover:bg-emerald-700">
