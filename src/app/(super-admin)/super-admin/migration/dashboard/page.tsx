  ...
  if (!data) {
    return (
      <div className="text-center text-gray-500">
        Failed to load migration dashboard data
      </div>
    );
  }
    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Current phase: {data.migrationProgress.phase}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              ...
              <div>
                ...
                <div className={`font-medium ${getStatusColor(data.currentMetrics.reconciliationStatus)}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {data.currentMetrics.dataIntegrityScore >= 99.9 ? 'Excellent' : 
               data.currentMetrics.dataIntegrityScore >= 99 ? 'Good' : 'Needs Attention'}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${data.currentMetrics.errorRate > 1 ? 'text-red-600' : 'text-green-600'}`}>
        ...
        <TabsContent value="metrics">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Last 24 hours of migration performance
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="logs">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest migration operations and their status
              </CardDescription>
            </CardHeader>
            <CardContent>
