      ...
      >
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
          ...
          <p className='mb-6 text-gray-600 dark:text-slate-400'>
            This admin page doesn&apos;t exist. You may not have permission to access it, or it may
            have been moved.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className='mt-8'
        >
          <p className='mb-4 text-sm text-gray-500 dark:text-slate-500'>Admin sections:</p>
