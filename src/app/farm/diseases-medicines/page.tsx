    ...
    <div className='space-y-6'>
          ...
          <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Frequently occurring diseases in your region</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {[
                    ...
                    >
                      <div>
                        ...
                        <p className='text-sm capitalize text-gray-500'>{disease.category}</p>
                      </div>
                      <Badge
                        variant={
      ...
      <Dialog open={showDiseaseDetail} onOpenChange={setShowDiseaseDetail}>
        <DialogContent className='max-h-[90vh] max-w-4xl overflow-y-auto'>
          {selectedDisease && (
            <DiseaseDetail disease={selectedDisease} onClose={() => setShowDiseaseDetail(false)} />
          )}
        </DialogContent>
      </Dialog>
