    ...
    <div className='flex min-h-[60vh] flex-col items-center justify-center px-4 text-center'>
      ...
      >
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
          <h1 className='mb-3 text-2xl font-bold text-gray-900 dark:text-white'>Page Not Found</h1>
        ...
        <motion.div
          ...
          className='mt-8'
        >
          <p className='mb-4 text-sm text-gray-500 dark:text-slate-500'>Or navigate to:</p>
