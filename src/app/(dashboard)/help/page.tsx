...
const faqItems = [
  {
    ...
    answer:
      'Go to Animals page and click "Add Animal". Fill in the details like tag number, species, breed, and date of birth. You can also upload a photo.',
  },
  {
    question: 'How can I track my milk production?',
    answer:
      'Navigate to the Milk page and click "Log Milk". Record the quantity, session (morning/evening), and quality rating for each milking.',
  },
  {
    question: 'What should I do in case of animal emergency?',
    answer:
      'Use the WhatsApp button to contact our vet team immediately. Select "Veterinary Doctor" for urgent health guidance. You can also call us directly at 0303-8111297.',
  },
  {
    question: 'How do I upgrade my subscription plan?',
    answer:
      'Go to Subscription page to view available plans. Select your desired plan and complete the payment. Your account will be upgraded immediately.',
  },
  {
    question: 'Can I add staff members to my farm account?',
    answer:
      'Yes! Go to Staff page from the settings menu. You can invite staff with different roles like Manager, Worker, or Viewer.',
  },
  {
    question: 'How do I generate reports for my farm?',
    answer:
      'Visit the Analytics page and click on "Generate Report". Select the date range and report type (Animals, Milk, Health, or Financial).',
  },
];
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='space-y-8 p-6'>
            ...
            >
              ...
              <div className='p-6'>
                <div className='flex items-start gap-4'>
                  <div
                    className={`rounded-xl bg-gradient-to-br ${channel.color} p-3 text-white shadow-lg`}
                  >
      ...
      >
        <div className='flex flex-col items-center text-center md:flex-row md:text-left'>
          ...
          <div className='flex-1'>
            <h3 className='mb-2 text-xl font-bold text-gray-900 dark:text-white'>{TEAM_NAME}</h3>
            <p className='mb-4 text-gray-600 dark:text-slate-300'>
              We&apos;re a passionate team of dairy farming experts, veterinarians, and
              technologists dedicated to empowering farmers across Pakistan with modern dairy
              management tools.
            </p>
