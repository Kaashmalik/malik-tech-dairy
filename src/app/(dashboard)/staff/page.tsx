...
export default function TeamManagementPage() {
  ...
  return (
    <ProtectedRoute
      requiredRole={[TenantRole.FARM_OWNER, TenantRole.FARM_MANAGER]}
    >
      <div className="p-6 space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Team Management</h1>
          <p className="text-gray-600 mt-2">
            Manage your farm team members and their roles
          </p>
        </div>
          ...
          <Card className="p-6">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <option value={TenantRole.BREEDER}>
                  {ROLE_DISPLAY_NAMES[TenantRole.BREEDER]}
                </option>
                ...
                <option value={TenantRole.GUEST}>
                  {ROLE_DISPLAY_NAMES[TenantRole.GUEST]}
                </option>
              </select>
