...
import { Heart, Baby, Stethoscope, Syringe, Calendar, TrendingUp, Package } from 'lucide-react';
              ...
              {checksLoading ? (
                ...
                <div className='text-muted-foreground py-12 text-center'>
                  ...
                  <p className='mt-2 text-sm'>
                    Pregnancy checks will appear here after you record them from the Breeding
                    Records tab
                  </p>
                </div>
              ) : (
                    ...
                    >
                      <div className='flex items-start justify-between'>
                        <div className='space-y-1'>
                          ...
                          {check.vetName && (
                            <p className='text-muted-foreground text-xs'>Vet: {check.vetName}</p>
                          )}
                          {check.notes && (
                            <p className='text-muted-foreground mt-1 text-xs'>{check.notes}</p>
                          )}
                        </div>
                        <div className='text-right'>
                          ...
                          {check.cost && (
                            <p className='text-muted-foreground text-xs'>Cost: Rs. {check.cost}</p>
                          )}
                        </div>
                      </div>
                    </div>
