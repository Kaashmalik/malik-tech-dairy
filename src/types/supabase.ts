  ...
  public: {
    Tables: {
      ...
      milk_logs: {
        ...
        Insert: Omit<
          Database['public']['Tables']['milk_logs']['Row'],
          'id' | 'created_at' | 'updated_at'
        >;
      ...
      breeding_records: {
        ...
        Insert: Omit<
          Database['public']['Tables']['breeding_records']['Row'],
          'id' | 'created_at' | 'updated_at'
        >;
      ...
      platform_users: {
        ...
        Insert: Omit<
          Database['public']['Tables']['platform_users']['Row'],
          'id' | 'created_at' | 'updated_at'
        >;
      ...
      farm_applications: {
        ...
        Insert: Omit<
          Database['public']['Tables']['farm_applications']['Row'],
          'id' | 'created_at' | 'updated_at'
        >;
      ...
      custom_fields_config: {
        ...
        Insert: Omit<
          Database['public']['Tables']['custom_fields_config']['Row'],
          'id' | 'created_at' | 'updated_at'
        >;
