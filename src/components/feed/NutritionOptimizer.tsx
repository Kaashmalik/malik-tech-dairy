          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatCurrency(Math.round(plans.reduce((sum, p) => sum + p.costPerDay, 0) / plans.length))}
                </p>
              </div>
                  ...
                  <div key={plan.id} className="p-4 border rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{plan.animalGroup} • {plan.targetProduction}</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className={cn('text-sm font-bold', getEfficiencyColor(plan.efficiency))}>
                          {plan.efficiency}%
                        </span>
                  ...
                  <div key={index} className="p-4 border rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <span className="ml-2 font-medium">{formatCurrency(ingredient.cost)}/kg</span>
                      </div>
                      <div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">AI Nutrition Optimizer</h3>
                <p className="text-gray-600 mb-4">
                  Advanced optimization algorithm will create nutritionally balanced feed formulations 
                  while minimizing costs based on available ingredients and animal requirements.
                </p>
                <Button className="mb-4">
                  <Activity className="h-4 w-4 mr-2" />
                  Run Optimization
                </Button>
                <div className="text-left p-4 bg-gray-50 rounded">
