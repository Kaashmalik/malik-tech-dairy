    ...
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3'>
        {diseases.map(disease => {
          const IconComponent =
            categoryIcons[disease.category as keyof typeof categoryIcons] || AlertCircle;

          return (
            <Card key={disease.id} className='cursor-pointer transition-shadow hover:shadow-lg'>
              <CardHeader>
                <div className='flex items-start justify-between'>
                  ...
                  <Badge
                    className={
                      severityColors[disease.severityDefault as keyof typeof severityColors]
                    }
                  >
              ...
              <CardContent>
                <div className='space-y-3'>
                  <div className='flex flex-wrap gap-2'>
                    ...
                    {disease.isNotifiable && <Badge variant='destructive'>Notifiable</Badge>}
                  </div>

                  <div>
                    <p className='mb-1 text-sm font-medium'>Affected Species:</p>
                  ...
                  {disease.symptoms.length > 0 && (
                    <div>
                      <p className='mb-1 text-sm font-medium'>Key Symptoms:</p>
                  ...
                  <div className='flex gap-2 pt-2'>
                    ...
                    {onTreatmentSelect && (
                      <Button size='sm' onClick={() => handleTreatment(disease)} className='flex-1'>
                        Treat
                      </Button>
                    )}
                  </div>
      ...
      {diseases.length === 0 && (
        <div className='py-12 text-center'>
          ...
          <h3 className='mb-2 text-lg font-medium text-gray-900'>No diseases found</h3>
