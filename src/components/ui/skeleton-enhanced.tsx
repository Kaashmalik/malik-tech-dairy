...
export function CardSkeleton({ lines = 3 }: { lines?: number }) {
  return (
    <div className='space-y-4 rounded-lg border border-white/10 bg-white/5 p-6 backdrop-blur-xl'>
  ...
  return (
    <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4'>
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className='rounded-lg border border-white/10 bg-white/5 p-6 backdrop-blur-xl'>
          <div className='flex items-center justify-between'>
            <div className='space-y-2'>
  ...
  return (
    <div className='space-y-4'>
      {Array.from({ length: items }).map((_, i) => (
        <div
          key={i}
          className='flex items-center gap-4 rounded-lg border border-white/10 bg-white/5 p-4 backdrop-blur-xl'
        >
          <Skeleton className='h-12 w-12 rounded-full' />
...
export function FormSkeleton({ fields = 5 }: { fields?: number }) {
  return (
    <div className='space-y-6 rounded-lg border border-white/10 bg-white/5 p-6 backdrop-blur-xl'>
      <Skeleton className='h-6 w-32' />
...
export function Shimmer({
  ...
  return (
    <div
      className={cn('relative overflow-hidden rounded bg-white/10', className)}
      style={{ width, height }}
    >
