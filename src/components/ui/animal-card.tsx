...
export function AnimalCard({ animal, className }: AnimalCardProps) {
  ...
  return (
    ...
    >
      ...
      <CardContent className='relative pt-0'>
        ...
        <div className='mb-4 grid grid-cols-2 gap-3'>
          ...
          {animal.lastHealthCheck && (
            <div className='flex items-center gap-2 rounded-lg border border-green-500/20 bg-green-500/10 p-2'>
        ...
        <div className='space-y-2'>
          {animal.nextVaccination && (
            <div className='flex items-center gap-2 text-xs'>
              ...
              <span className='text-white/60'>Next vaccination: {animal.nextVaccination}</span>
            </div>
          )}
        </div>
      ...
      <div className='pointer-events-none absolute inset-0 rounded-lg bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 opacity-0 transition-opacity duration-500 hover:opacity-100' />
    </Card>
  );
}
...
export function StatsCard({
  ...
  return (
    <Card className='border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:bg-white/10'>
      <CardContent className='p-6'>
        <div className='flex items-center justify-between'>
          <div className='space-y-1'>
            ...
            {change && (
              <p className={cn('flex items-center gap-1 text-xs', getTrendColor())}>
