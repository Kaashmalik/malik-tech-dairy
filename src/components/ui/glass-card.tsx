  ...
  return (
    <div
      className={cn(
        ...
        hoverEffect &&
          'group cursor-pointer hover:-translate-y-1 hover:border-white/40 hover:shadow-xl',
        gradient &&
          'bg-gradient-to-br from-white/60 to-white/30 dark:from-slate-900/60 dark:to-slate-900/30',
        className
      )}
      {...props}
    >
