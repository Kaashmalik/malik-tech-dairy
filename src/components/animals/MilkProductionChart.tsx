      ...
      <CardContent>
        ...
        <div className='mb-6 grid grid-cols-1 gap-4 md:grid-cols-3'>
          <div className='rounded-lg bg-blue-50 p-4'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-sm font-medium text-blue-600'>Average Daily Yield</p>
          ...
          <div className='rounded-lg bg-purple-50 p-4'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-sm font-medium text-purple-600'>Monthly Projection</p>
        ...
        <div className='space-y-6'>
          {chartType === 'yield' && (
            <div>
              <h3 className='mb-4 text-sm font-medium text-gray-700'>Daily Milk Production</h3>
          ...
          <div className='space-y-1'>
            {yieldTrend > 5 && (
              <p className='text-sm text-green-600'>
                • Excellent yield improvement of {yieldTrend.toFixed(1)}% this period
              </p>
            )}
            {yieldTrend < -5 && (
              <p className='text-sm text-red-600'>
                • Yield decline detected ({yieldTrend.toFixed(1)}%) - consider health check
              </p>
            )}
            {avgQuality > 85 && (
              <p className='text-sm text-green-600'>
                • High milk quality maintained ({avgQuality.toFixed(0)}/100)
              </p>
            )}
            {avgQuality < 80 && (
              <p className='text-sm text-yellow-600'>
                • Quality score below optimal ({avgQuality.toFixed(0)}/100)
              </p>
            )}
            {avgYield > 25 && (
              <p className='text-sm text-blue-600'>
                • Top performer with {avgYield.toFixed(1)}L daily average
              </p>
            )}
          </div>
        </div>
