  ...
  const getStockStatus = (item: InventoryItem) => {
    ...
    if (daysToExpiry <= 30)
      return {
        ...
        text: `Expiring in ${daysToExpiry} days`,
      };
    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your farm's medicine stock</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
          ...
          {inventory.length === 0 && (
            <div className='py-12 text-center'>
              ...
              <p className='mb-4 text-gray-500'>Start by adding medicines to your inventory</p>
