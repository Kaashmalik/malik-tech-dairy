...
// =====================================================
export const diseaseTreatments = pgTable(
  'disease_treatments',
  {
    id: text('id').primaryKey().default('gen_random_uuid()'),
...
export const vaccinationSchedules = pgTable(
  'vaccination_schedules',
  {
    ...
    vaccineMedicineId: text('vaccine_medicine_id').references(() => medicines.id, {
      onDelete: 'cascade',
    }),
...
// =====================================================
export const treatmentProtocols = pgTable(
  'treatment_protocols',
  {
    id: text('id').primaryKey().default('gen_random_uuid()'),
...
// =====================================================
export const tenantMedicineInventory = pgTable(
  'tenant_medicine_inventory',
  {
    id: text('id').primaryKey().default('gen_random_uuid()'),
...
// =====================================================
export const animalVaccinations = pgTable(
  'animal_vaccinations',
  {
    id: text('id').primaryKey().default('gen_random_uuid()'),
    tenantId: text('tenant_id').notNull(),
