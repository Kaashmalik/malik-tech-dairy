  ...
  try {
    ...
    for (const table of tables) {
      try {
        ...
        console.log(table.module.padEnd(25) + table.name.padEnd(20) + '0'.padEnd(10) + '❌ Error');
      }
    }
    ...
    for (const check of typeChecks) {
      ...
      console.log(
        `  ${status} ${check.table}.${check.column.padEnd(20)} ${actual.padEnd(15)} (expected: ${check.expected})`
      );
    }
