  ...
  try {
    ...
    const modules = [
      { name: 'Animals', table: 'animals', fields: 'id, tag, name, species, breed, created_at' },
      {
        name: 'Milk Logs',
        table: 'milk_logs',
        fields: 'id, animal_id, date, quantity, session, created_at',
      },
      {
        name: 'Health Records',
        table: 'health_records',
        fields: 'id, animal_id, date, diagnosis, treatment, created_at',
      },
      {
        name: 'Breeding Records',
        table: 'breeding_records',
        fields: 'id, animal_id, date, type, status, created_at',
      },
      {
        name: 'Medicine Inventory',
        table: 'medicine_inventory',
        fields: 'id, name, quantity, unit, expiry_date',
      },
      {
        name: 'Medicine Logs',
        table: 'medicine_logs',
        fields: 'id, medicine_id, animal_id, date, dosage, created_at',
      },
      {
        name: 'Assets',
        table: 'assets',
        fields: 'id, name, type, value, purchase_date, created_at',
      },
      {
        name: 'Expenses',
        table: 'expenses',
      ...
      },
      {
        name: 'Feed Logs',
        table: 'feed_logs',
        fields: 'id, animal_id, date, feed_type, quantity, created_at',
      },
    ];
