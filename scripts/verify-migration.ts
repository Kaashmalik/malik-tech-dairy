...
const expectedTables = [
  {
    ...
    requiredColumns: [
      'id', 'tenant_id', 'animal_id', 'sire_id', 'dam_id', 'breed_score',
      'milk_yield_potential', 'genetic_value_index', 'laboratory', 'created_at', 'updated_at'
    ],
    foreignKeys: [
  ...
  },
  {
    name: 'feed_inventory',
    requiredColumns: [
      'id', 'tenant_id', 'ingredient_name', 'category', 'current_stock', 'unit',
      'reorder_level', 'max_stock_level', 'unit_cost', 'total_value', 'supplier_name',
      'batch_number', 'manufacture_date', 'expiry_date', 'storage_location',
      'quality_grade', 'moisture_content', 'protein_content', 'energy_content',
      'average_daily_consumption', 'is_active', 'created_by', 'created_at', 'updated_at'
    ],
    foreignKeys: [
      { from: 'tenant_id', to: 'tenants(id)' },
  ...
  },
  {
    ...
    requiredColumns: [
      'id', 'tenant_id', 'animal_category', 'production_stage', 'min_protein',
      'max_protein', 'min_energy', 'max_energy', 'min_fiber', 'max_fiber',
      'min_moisture', 'max_moisture', 'created_by', 'created_at', 'updated_at'
    ],
    foreignKeys: [
      { from: 'tenant_id', to: 'tenants(id)' },
      { from: 'created_by', to: 'platform_users(id)' }
  ...
  },
  {
    ...
    requiredColumns: [
      'id', 'tenant_id', 'animal_id', 'image_url', 'analysis_type',
      'body_condition_score', 'confidence_score', 'health_indicators',
      'analysis_results', 'verified_by', 'verification_status', 'created_at', 'updated_at'
    ],
    foreignKeys: [
      { from: 'tenant_id', to: 'tenants(id)' },
      { from: 'animal_id', to: 'animals(id)' },
  ...
  },
  {
    ...
    requiredColumns: [
      'id', 'tenant_id', 'account_name', 'account_type', 'account_number',
      'bank_name', 'balance', 'currency', 'status', 'parent_account_id',
  ...
  },
  {
    ...
    requiredColumns: [
      'id', 'tenant_id', 'user_id', 'certification_name', 'issuing_organization',
      'certificate_number', 'issue_date', 'expiry_date', 'status', 'document_url',
      'created_by', 'created_at', 'updated_at'
    ],
    foreignKeys: [
      { from: 'tenant_id', to: 'tenants(id)' },
  ...
  },
  {
    ...
    requiredColumns: [
      'id', 'tenant_id', 'compliance_type', 'reference_number', 'issue_date',
      'expiry_date', 'status', 'compliance_officer_id', 'documents',
  ...
  },
  {
    ...
    requiredColumns: [
      'id', 'tenant_id', 'transaction_hash', 'block_number', 'transaction_type',
      'asset_type', 'asset_id', 'from_address', 'to_address', 'timestamp',
      'metadata', 'created_at'
    ],
    foreignKeys: [
      { from: 'tenant_id', to: 'tenants(id)' }
  ...
  },
  {
    name: 'drone_flights',
    requiredColumns: [
      'id', 'tenant_id', 'flight_date', 'flight_duration', 'area_covered',
      'flight_type', 'pilot_id', 'weather_conditions', 'data_collected',
...
async function checkForeignKeys(tableName: string, foreignKeys: Array<{from: string, to: string}>): Promise<boolean> {
  try {
